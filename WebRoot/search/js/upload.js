			...
			if((null==result)||(""==result)){
				...
				if(data!=[] && data!="" && data.length!=0){
					...
					for(var i=start;i<end;i++){
						var obj = data[i];
						FileHtml +='  <div class="item global-clearfix"><div style="width: 40%" class="col c1">'+obj.filename+'</div><div style="width: 16%;" class="col">'+obj.size+'</div><div style="width: 23%;" class="col">'+obj.modify+'</div><div style="width: 20%;" class="col"><a href="'+basePath +'pages/DownLoad/TransferFile.do?filename='+obj.filename+'&dir=search&category=class">设置为在线课程</a> | <a href="'+basePath +'pages/DownLoad/TransferFile.do?filename='+obj.filename+'&dir=search&category=mat">设置为实验素材</a> | <a href="'+basePath +'pages/DownLoad/TransferFile.do?filename='+obj.filename+'&dir=search&category=stu">设置为学生作品</a> | <a class="del" href="javascript:;">删除</a></div></div>';
					}
