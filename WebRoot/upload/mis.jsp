    ...
    <div class="module-toolbar">
        <div class="bar global-clearfix" style="margin-left:15px;margin-top: 1%;">
            <div style="float:left;width:35%;height: 42px;">
	            <form name="upform" action= "<%=basePath %>pages/Upload/UploadFile.do?dir=mis" method="POST" enctype="multipart/form-data">
	            <input type ="file" name= "file1" id="file1" />
	            <input type= "submit" value ="文件上传" style="width: 10%"/>
	            </form>
            </div>
            <div style="float:left;width:30%">
            <a href="<%=basePath %>mis/show.jsp">信息系统分析与设计课件上传管理界面（点击进入前台）</a>
            </div>
...
<script type="text/javascript" src="<%=basePath %>mis/js/upload.js"></script>
